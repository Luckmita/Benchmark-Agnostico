...
Status: `APPROVED - CORRECTIVE B1 FRAMEWORK - 2026-09-02`

Registro historico: `docs/reviews/B0_B1_GATE_REVIEW_2026-08-31.md`

Revisao vigente: `docs/reviews/GATE_AUDIT_2026-09-01.md`

Registro de aprovacao: `docs/reviews/B1_CORRECTIVE_APPROVAL_2026-09-02.md`
...
As linhas acima foram aprovadas pelo responsavel do projeto como estrutura de B1. A aprovacao define o que cada capacidade mede e como sua validade sera julgada; nao substitui o preregistro quantitativo de seeds, budgets, limiares, splits, bins e testes estatisticos antes de cada experimento confirmatorio.
