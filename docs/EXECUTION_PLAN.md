...
B2 e B3 receberam `PASS` em 2026-09-02. O ambiente B3 de referencia, claims de `run_id`, raw imutavel, registry, artefatos, hashes e CLI foram reproduzidos em instalacao limpa. B4 e o gate atual.
