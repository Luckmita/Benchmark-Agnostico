...
| B3 | registry, rastreabilidade e reproducao | ambiente versionado; IDs unicos; runner; CLI; registry; raw imutavel; artefatos; hashes | PASS | imagem por digest permanece requisito de release B14 |
| B4 | controles implementados e validados | Random e EpsilonGreedy exploratorios em bandit | IN REVIEW | matriz de controles e validacao pertinente por construto |
